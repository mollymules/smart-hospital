...
public class Tempature_machine extends UnicastRemoteObject implements machine, Runnable {
	/* This is Kevs bit no laughing at my code :( */

	private static final String SERVICE_TYPE = "smart_hospital._tcp.local.";
	private static final String SERVICE_NAME = "Temp";
	...
	String tempature_Result;
	protected MulticastSocket socket;
	protected InetAddress multicastAddress;
	private DoctorDisplay dd;

	public Tempature_machine(String location, String add, int multiPort) throws RemoteException, MalformedURLException{
		try {
	...
	public void completeTask(String patientID) {
		int temp = 35 + (int) (Math.random() * ((39 - 35) + 1));
		
		this.tempature_Result = Integer.toString(temp);
		...
		"<blood_pressure>"+tempature_Result+"</blood_pressure>\n"+
	...
	public static void main(String[] args) throws IOException {
		...
		Tempature_machine machine = new Tempature_machine("Ward 3","230.0.0.1", 4444);
