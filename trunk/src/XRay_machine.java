...
public class XRay_machine extends UnicastRemoteObject implements Runnable {
	...
	public XRay_machine(String location, String add, int multiPort) throws RemoteException, MalformedURLException{
		try {
